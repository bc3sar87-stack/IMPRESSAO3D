...
export async function GET() {
  ...
  const { rows } = await pool.query(
    `SELECT mp.codigo, t.nome AS tipo_nome, mp.marca, mp.cor, mp.cor_hex, mp.fornecedor,
     ...
     GROUP BY mp.codigo, t.nome, mp.marca, mp.cor, mp.cor_hex, mp.fornecedor, u.sigla
     ORDER BY mp.codigo`,
